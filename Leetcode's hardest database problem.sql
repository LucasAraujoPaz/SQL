/* Hardest database problem in LeetCode platform:
262. Trips and Users
Level: Hard. Accceptance: 34.9% (Site: https://leetcode.com/problems/trips-and-users/ ; Access in 2021-02-25)
...
Cancelled AS 
(SELECT `Day`, COUNT(*) AS cancelled_per_day FROM Unbanned_Requests
